...
function repn(r, i, j) {
  if (i < 0) {
    Pervasives.invalid_arg("Re.repn");
  }
  if (j !== undefined && j < i) {
    Pervasives.invalid_arg("Re.repn");
  }
...
function inter(l) {
  ...
  if (is_charset(r)) {
    ...
    return Pervasives.invalid_arg("Re.inter");
  }
}
...
function compl(l) {
  ...
  if (is_charset(r)) {
    ...
    return Pervasives.invalid_arg("Re.compl");
  }
}
...
function diff(r, r$p) {
  ...
  if (is_charset(r$p$p)) {
    ...
    return Pervasives.invalid_arg("Re.diff");
  }
}
...
function all$1(posOpt, len, re, s) {
  var pos = posOpt !== undefined ? posOpt : 0;
  if (pos < 0) {
    Pervasives.invalid_arg("Re.all");
  }
  var limit = len !== undefined ? (len < 0 || (pos + len | 0) > s.length ? Pervasives.invalid_arg("Re.all") : undefined, pos + len | 0) : s.length;
...
function split_full(posOpt, len, re, s) {
  var pos = posOpt !== undefined ? posOpt : 0;
  if (pos < 0) {
    Pervasives.invalid_arg("Re.split");
  }
  var limit = len !== undefined ? (len < 0 || (pos + len | 0) > s.length ? Pervasives.invalid_arg("Re.split") : undefined, pos + len | 0) : s.length;
...
function replace(posOpt, len, allOpt, re, f, s) {
  ...
  if (pos < 0) {
    Pervasives.invalid_arg("Re.replace");
  }
  var limit = len !== undefined ? (len < 0 || (pos + len | 0) > s.length ? Pervasives.invalid_arg("Re.replace") : undefined, pos + len | 0) : s.length;
