...
function pp_rep_kind(fmt, param) {
  if (param === "Non_greedy") {
    console.log(fmt, "Non_greedy");
  } else {
    console.log(fmt, "Greedy");
  }
...
function deriv_seq(all_chars, categories, cat, kind, y, z, rem) {
  ...
  return List.fold_right((function (param, rem) {
                ...
                if (kind === "Longest") {
                  return Cset.prepend(s, tseq(kind, Curry._1(remove_matches, y), z, /* [] */0), prepend_deriv(restrict(s, z$p$p), rem));
                }
                if (kind !== "First") {
                  return prepend_deriv(restrict(s, z$p$p), Cset.prepend(s, tseq(kind, Curry._1(remove_matches, y), z, /* [] */0), rem));
                }
                var match = split_at_match_rec(/* [] */0, y);
...
function deriv_4(all_chars, categories, cat, l, rem) {
  if (l) {
    var x = l.hd;
    var rem$1 = deriv_4(all_chars, categories, cat, l.tl, rem);
    switch (x.TAG | 0) {
      case /* TSeq */0 :
          ...
          return deriv_seq(all_chars, categories, cat, x._2, y$p, x._1, rem$1);
      case /* TExp */1 :
          return deriv_1(all_chars, categories, x._0, cat, x._1, rem$1);
      case /* TMatch */2 :
          return Cset.prepend(all_chars, {
                      hd: x,
                      tl: /* [] */0
